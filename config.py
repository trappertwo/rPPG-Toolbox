...
#### Added for image restoration of compressed videos
...
_C.TRAIN.DATA.PREPROCESS.RESTORE.IMG_SIZE = 126
_C.TRAIN.DATA.PREPROCESS.RESTORE.DIFF_NORMALIZE_AFTER_RESTORATION = False
...
#### Added for image restoration of compressed videos
_C.VALID.DATA.PREPROCESS.RESTORE = CN()
_C.VALID.DATA.PREPROCESS.RESTORE.DO_RESTORE = False
_C.VALID.DATA.PREPROCESS.RESTORE.MODEL_PATH = ''
_C.VALID.DATA.PREPROCESS.RESTORE.IMG_SIZE = 126
_C.VALID.DATA.PREPROCESS.RESTORE.DIFF_NORMALIZE_AFTER_RESTORATION = False
...
#### Added for image restoration of compressed videos
_C.TEST.DATA.PREPROCESS.RESTORE = CN()
_C.TEST.DATA.PREPROCESS.RESTORE.DO_RESTORE = False
_C.TEST.DATA.PREPROCESS.RESTORE.MODEL_PATH = ''
_C.TEST.DATA.PREPROCESS.RESTORE.IMG_SIZE = 126
_C.TEST.DATA.PREPROCESS.RESTORE.DIFF_NORMALIZE_AFTER_RESTORATION = False
...
_C.UNSUPERVISED.DATA.PREPROCESS.RESTORE = CN()
_C.UNSUPERVISED.DATA.PREPROCESS.RESTORE.DO_RESTORE = False
_C.UNSUPERVISED.DATA.PREPROCESS.RESTORE.MODEL_PATH = ''
_C.UNSUPERVISED.DATA.PREPROCESS.RESTORE.IMG_SIZE = 126
_C.UNSUPERVISED.DATA.PREPROCESS.RESTORE.DIFF_NORMALIZE_AFTER_RESTORATION = False
...
_C.MODEL.PHYSNET.USE_SWINPHYS = False
_C.MODEL.PHYSNET.SWINPHYS_DIFF_NORMALIZE = True
